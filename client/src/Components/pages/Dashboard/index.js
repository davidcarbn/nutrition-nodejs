                        ...
                        <Container>
                            <ContainerChild>
                                <Container flexRow wrap>
                                    ...
                                    <Nutrient name="Kalium" amount={foodSum.potassium || 0} unit="mg" rda={rda.potassium || 0} />
                                    <Nutrient name="Phosphat" amount={foodSum.phosphate || 0} unit="mg" rda={rda.phosphate || 0} />
                                </Container>
