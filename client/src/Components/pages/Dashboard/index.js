...
const Dashboard = (props) => {
  ...
  const sumAllFood = () => {
    ...
    const allFood = diaryEntry.breakfast
      .concat(diaryEntry.lunch)
      .concat(diaryEntry.dinner)
      .concat(diaryEntry.snacks);
    const FoodProps = [
      "name",
      "kcal",
      "protein",
  ...
  const prevDay = (event) => {
    ...
    setCurrentDate((currentDate) => (currentDate - 60 * 1000 * 60 * 24));
  };
  const nextDay = (event) => {
    event.preventDefault();
    stateMutate.current = true;
        ...
        <div className="date-selector">
          <button onClick={prevDay}>
            <svg
              ...
              width="9.843"
              height="15.444"
              viewBox="0 0 9.843 15.444"
            >
              <path
                id="left-arrow"
                d="M149.076,42.925l-5.6,5.6,5.6,5.6"
                transform="translate(-141.354 -40.804)"
                fill="none"
                stroke="#343540"
          ...
          <button onClick={nextDay}>
            ...
            >
              <path
                id="right-arrow"
                d="M143.475,42.925l5.6,5.6-5.6,5.6"
                transform="translate(-141.354 -40.804)"
                fill="none"
                stroke="#343540"
                stroke-linecap="round"
      ...
      <Content>
          <Container>
            <Container flexRow wrap noSpacing>
              ...
              <Nutrient
                name="Kalium"
                amount={foodSum.potassium || 0}
                unit="mg"
                rda={rda.potassium || 0}
              />
              <Nutrient
                name="Phosphat"
                amount={foodSum.phosphate || 0}
                unit="mg"
                rda={rda.phosphate || 0}
              />
            </Container>
            <Container flexRow justifyCenter noSpacing>
              <Link
                to={{
          ...
          <Container>
            <DiaryList
              ...
              content={
                getDiaryByDate()
                  ? diary.get(new Date(currentDate).toISOString()).breakfast
                  : []
              }
          ...
          <Container>
            <DiaryList
              ...
              content={
                getDiaryByDate()
                  ? diary.get(new Date(currentDate).toISOString()).lunch
                  : []
              }
              onEdit={redirectToEditPage}
            />
          ...
          <Container>
            <DiaryList
              ...
              content={
                getDiaryByDate()
                  ? diary.get(new Date(currentDate).toISOString()).dinner
                  : []
              }
              onEdit={redirectToEditPage}
            />
          ...
          <Container>
            <DiaryList
              ...
              content={
                getDiaryByDate()
                  ? diary.get(new Date(currentDate).toISOString()).snacks
                  : []
              }
              onEdit={redirectToEditPage}
            />
