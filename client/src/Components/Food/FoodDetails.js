              ...
              <div className="nutrition-sub-list-name">
                ...
                <div className="nutrition-nutrient-quantity">
                  <input
                    ...
                    data-key="transFats"
                    value={
                      asInput ? food.transFats : (food.transFats * amount) / 100
                    }
                    placeholder="0"
                    onChange={updateFood}
                    disabled={!asInput}
              ...
              <div className="nutrition-sub-list-name">
                ...
                <div className="nutrition-nutrient-quantity">
                  <input
                    ...
                    value={
                      asInput
                        ? food.polyunsaturatedFats
                        : (food.polyunsaturatedFats * amount) / 100
                    }
                    placeholder="0"
                    onChange={updateFood}
                    disabled={!asInput}
              ...
              <div className="nutrition-sub-list-name">
                ...
                <div className="nutrition-nutrient-quantity">
                  <input
                    ...
                    value={
                      asInput
                        ? food.monounsaturatedFats
                        : (food.monounsaturatedFats * amount) / 100
                    }
                    placeholder="0"
                    onChange={updateFood}
                    disabled={!asInput}
          ...
          <div className="nutrition-list-name">
            ...
            <div className="nutrition-nutrient-quantity">
              <input
                ...
                onChange={updateFood}
                value={
                  asInput ? food.potassium : (food.potassium * amount) / 100
                }
                placeholder="0"
                disabled={!asInput}
              />
          ...
          <div className="nutrition-list-name">
            ...
            <div className="nutrition-nutrient-quantity">
              <input
                ...
                data-key="phosphate"
                value={
                  asInput ? food.phosphate : (food.phosphate * amount) / 100
                }
                placeholder="0"
                onChange={updateFood}
                disabled={!asInput}
          ...
          <div className="nutrition-list-name">
            ...
            <div className="nutrition-nutrient-quantity">
              <input
                ...
                data-key="vitamineA"
                value={
                  asInput ? food.vitamineA : (food.vitamineA * amount) / 100
                }
                placeholder="0"
                onChange={updateFood}
                disabled={!asInput}
          ...
          <div className="nutrition-list-name">
            ...
            <div className="nutrition-nutrient-quantity">
              <input
                className="nutrition-nutrient-value"
                value={(
                  parseFloat((food.vitamineB1 * amount) / 100) +
                  parseFloat((food.vitamineB2 * amount) / 100) +
                  parseFloat((food.vitamineB3 * amount) / 100) +
                  parseFloat((food.vitamineB5 * amount) / 100) +
                  parseFloat((food.vitamineB7 * amount) / 100) +
                  parseFloat((food.vitamineB9 * amount) / 100) +
                  parseFloat((food.vitamineB12 * amount) / 100)
                ).toFixed(1)}
                disabled
              />
              <div className="nutrition-nutrient-unit">mg</div>
          ...
          <div className="nutrition-list-name">
            ...
            <div className="nutrition-nutrient-quantity">
              <input
                ...
                data-key="vitamineC"
                value={
                  asInput ? food.vitamineC : (food.vitamineC * amount) / 100
                }
                placeholder="0"
                onChange={updateFood}
                disabled={!asInput}
          ...
          <div className="nutrition-list-name">
            ...
            <div className="nutrition-nutrient-quantity">
              <input
                ...
                data-key="vitamineD"
                value={
                  asInput ? food.vitamineD : (food.vitamineD * amount) / 100
                }
                placeholder="0"
                onChange={updateFood}
                disabled={!asInput}
          ...
          <div className="nutrition-list-name">
            ...
            <div className="nutrition-nutrient-quantity">
              <input
                ...
                data-key="vitamineE"
                value={
                  asInput ? food.vitamineE : (food.vitamineE * amount) / 100
                }
                placeholder="0"
                onChange={updateFood}
                disabled={!asInput}
          ...
          <div className="nutrition-list-name">
            ...
            <div className="nutrition-nutrient-quantity">
              <input
                ...
                data-key="vitamineK"
                value={
                  asInput ? food.vitamineK : (food.vitamineK * amount) / 100
                }
                placeholder="0"
                onChange={updateFood}
                disabled={!asInput}
